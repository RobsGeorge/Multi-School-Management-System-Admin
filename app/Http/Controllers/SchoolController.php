...
class SchoolController extends Controller {
    ...
    public function checkSubdomainHealth($id) {
        ...
        try {
            ...
            $healthResult = $this->subdomainService->checkSubdomainHealth($school);
            ...
            ResponseService::logErrorResponse($e, "School Controller -> checkSubdomainHealth method");
            ResponseService::errorResponse('Failed to check subdomain health');
        }
    }

    public function getAllSubdomainHealth() {
        ResponseService::noPermissionThenSendJson('schools-list');
        
        try {
            $healthResults = $this->subdomainService->getAllSubdomainHealth();
