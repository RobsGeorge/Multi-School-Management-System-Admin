        ...
        $(document).ready(function() {
            $('#table_list').on('load-error.bs.table', function (e, status, res) {
                ...
                if (res.responseJSON && res.responseJSON.message) {
                    alert('Error loading data: ' + res.responseJSON.message);
                } else {
                    alert('Error loading schools data. Please try again.');
                }
            });
            
            // Add timeout handling
            $('#table_list').on('load-timeout.bs.table', function (e, status, res) {
                console.error('Table load timeout:', status, res);
